...
Dictionary<string, ExcelSheetForComparison> orig = er.ReadEntireExcel(@"C:\Projects\excel-comparer\Compare_excel_library\assets\Original_long.xlsx", ExcelReader.ColKeyOptions.CONCATENATED_COLS, new List<int>() { 1, 2});
Dictionary<string, ExcelSheetForComparison> comp = er.ReadEntireExcel(@"C:\Projects\excel-comparer\Compare_excel_library\assets\Comparison_long.xlsx", ExcelReader.ColKeyOptions.CONCATENATED_COLS, new List<int>() { 1, 2});
